...
namespace JabNetClient
{
    ...
    {
        static public string ERE1(string decrypted, string alphabet, Int32 shift)
        {
            string encrypted = "";
            ...
            for (Int32 i = 1; i < decrypted.Length; i++) //Encrypt the rest of the message
            {
                encrypted += alphabet[(alphabet.IndexOf(decrypted[i]) + 1 + alphabet.IndexOf(encrypted[i - 1])) % alphabet.Length];
            }
            return encrypted;
        }
        static public string DRE1(string encrypted, string alphabet, Int32 shift)
        {
            string Decoded = "";
            ...
            for (Int32 i = 1; i < encrypted.Length; i++) //Decrypt the rest of the message
            {
        ...
        static public string ERE2(string decrypted, string alphabet, Int32 Shift)
        {
            string encrypted = "";
        ...
        static public string DRE2(string encrypted, string alphabet, Int32 shift)
        {
            string decrypted = "";
        ...
        static public string ERE3(string decrypted, string alphabet, Int32 shift)
        {
            string encrypted = "";
        ...
        static public string DRE3(string encrypted, string alphabet, Int32 shift)
        {
            string decrypted = "";
        ...
        static public string ERE4(string decrypted, string alphabet, Int32 shift)
        {
            string encrypted = "";
            Int32 length = alphabet.Length, messageLength = decrypted.Length;
        ...
        static public string DRE4(string encrypted, string alphabet, Int32 shift)
        {
            string decrypted = "";
            Int32 length = alphabet.Length, messageLength = encrypted.Length;
        ...
        //-------------------------------------------------------------------------------//
        static public void ERE1Info(string encrypted, string decrypted, string alphabet, Int32 shift)
        {
            ...
            for (Int32 i = 1; i < decrypted.Length; i++)
        ...
        static public void DRE1Info(string encrypted, string decrypted, string alphabet, Int32 shift)
        {
            ...
            for (Int32 i = 1; i < encrypted.Length; i++)
        ...
        static public void ERE2Info(string encrypted, string decrypted, string alphabet, Int32 shift)
        {
            Write("\n\t\t[i]  - "); //Write info on the first encrypted character
        ...
        static public void DRE2Info(string encrypted, string decrypted, string alphabet, Int32 shift)
        {
            Write("\n\t\t[i]  - "); //Write info about the first decrypted character
        ...
        static public void ERE3Info(string encrypted, string decrypted, string alphabet, Int32 shift)
        {
            Write("\n\t\t[i]  - "); //Write info on the first encrypted character
            Write(alphabet.IndexOf(decrypted[0]) + "+" + shift + "=" + alphabet.IndexOf(encrypted[0]) + "/");
            if (encrypted[0] != ' ') Write(encrypted[0] + "  ");
        ...
        static public void DRE3Info(string encrypted, string decrypted, string alphabet, Int32 shift)
        {
            Write("\n\t\t[i]  - "); //Write info about the first decrypted character
            Write(alphabet.IndexOf(encrypted[0]) + "-" + shift + "=" + alphabet.IndexOf(decrypted[0]) + "/");
            if (decrypted[0] != ' ') Write(decrypted[0] + "  ");
        ...
        static public void ERE4Info(string encrypted, string decrypted, string alphabet, Int32 shift)
        {
            ...
            for (Int32 i = 1; i < decrypted.Length; i++) //Write info about the rest of the encrypted message
            {
        ...
        static public void DRE4Info(string encrypted, string decrypted, string Alphabet, Int32 Shift)
        {
            ...
            for (Int32 i = 2; i < encrypted.Length; i++)
        ...
        static public string GenerateRandomSecureREkey(byte cipherVersion, bool setting1, bool setting2, bool setting3, bool setting4)
        {
